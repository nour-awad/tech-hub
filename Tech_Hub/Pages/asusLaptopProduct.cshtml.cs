...
{
    public class asusLaptopProductModel : PageModel
    {
		DatabaseOperations Operation = new DatabaseOperations();


		public asusLaptopProductModel()
		{
		...
		{
			DatabaseOperations.InsertCartData("Data Source=kimo;Initial Catalog=\"TechHub Database\";Integrated Security=True", 33, 1, 1, 1);
		}
