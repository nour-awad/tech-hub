...
{
    public class PhonesProductModel : PageModel
    {
		DatabaseOperations Operation = new DatabaseOperations();


		public PhonesProductModel()
		{
		...
		{
			DatabaseOperations.InsertCartData("Data Source=kimo;Initial Catalog=\"TechHub Database\";Integrated Security=True", 38, 1, 1, 1);
		}
	}
}
