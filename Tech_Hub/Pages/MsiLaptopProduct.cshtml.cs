...
{
    public class MsiLaptopProductModel : PageModel
    {
		DatabaseOperations Operation = new DatabaseOperations();


		public MsiLaptopProductModel()
		{
		...
		{
			DatabaseOperations.InsertCartData("Data Source=kimo;Initial Catalog=\"TechHub Database\";Integrated Security=True", 37, 1, 1, 1);
		}
	}
}
